...
func TestGetMeetingPartcipants(t *testing.T) {
	...
	participant, err := client.GetMeetingPartcipants("8722824397", "8722824397")
	if err != nil {
		t.Error(err)
	}

	assert.NotNil(t, participant, "Empty meetings returned")
}
